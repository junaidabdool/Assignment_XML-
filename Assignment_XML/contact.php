<?php
	if (isset($_POST['insert']))
	{
		...
		$contactTag = $xml->createElement("contact");
			...
			$contactTag->appendChild($fnameTag);
			$contactTag->appendChild($lnameTag);
			$contactTag->appendChild($fnameTag);
			$contactTag->appendChild($emailTag);
			$contactTag->appendChild($subject);
			$contactTag->appendChild($message);

			$rootTag->appendChild($contactTag);
			$xml->save('contact_us.xml');
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="index.html">Jaskim Footwear</a></div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="row contact-info-wrap">
							<div class="col-md-3">
								<p><span><i class="icon-location"></i></span> La Caverne Vacoas, <br> Suite 721 New York NY 10016</p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-phone3"></i></span> <a href="tel:+230-52565487">+ 1235 2355 98</a></p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-paperplane"></i></span> <a href="">footware@gamil.com</a></p>
							</div>
